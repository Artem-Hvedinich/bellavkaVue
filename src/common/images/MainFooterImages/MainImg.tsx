...
export const MainImg = ({className}: { className?: string }) => {
    return (
        <svg className={className} width='25px' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 251.479 251.479">
