<template>
  <svg width="22px" height="22px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
        ...
        fill='#BD9365' stroke="#BD9365" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    <path
    ...
    <path
        ...
        stroke="#BD9365" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
</template>
<script>
export default {
